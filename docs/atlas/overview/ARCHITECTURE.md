...
sources:
  ...
  - path: docs/atlas/modules/plugins-atlas-bin-chunk-1.md
    blob: 30c17fd9448be279d6c393d10a5fea1b94cb7e69
  ...
  - path: docs/atlas/modules/plugins-atlas-helpers-ts-helper.md
    blob: bbb8c8416f6f2c9f42e0d653d2ce47554262880c
  - path: docs/atlas/modules/plugins-atlas-misc.md
    blob: b6634410ca2b5ba2358995d3d958c9f9358d2f1a
  - path: docs/atlas/modules/plugins-atlas-references.md
    blob: b5c98d486d75b2347c19a53ade56f36ceff418af
  - path: docs/atlas/modules/plugins-atlas-tests-chunk-1.md
    blob: 1a60b4d03658873ec8b90e6daebaf7397fab6a70
  - path: docs/atlas/modules/plugins-atlas-tests-chunk-2.md
    blob: 0f558df53335b0fa5284bdb42c323f9acb134435
  - path: docs/atlas/modules/plugins-atlas-tests-chunk-3.md
    blob: ac2c154ec5f9898ca8b9701fb56a1186ba20b7fa
  - path: docs/atlas/modules/plugins-council.md
    blob: bb73124f71faf6d3b9dbc968ea5de429d67f05ea
  - path: docs/atlas/modules/plugins-deployit-assets.md
    blob: 37fc10c6ba4e90f4285dd5824d852a083c1afec2
  - path: docs/atlas/modules/plugins-deployit-bin.md
    blob: 672ad23228f8a09f419f5e736127fcb432d368b5
  - path: docs/atlas/modules/plugins-deployit-misc.md
    blob: 3437b38898eebe8c4946f2863f37410dae049962
  ...
  - path: docs/atlas/modules/plugins-deployit-tests-chunk-2.md
    blob: 89c5f9ab04ac625ab7b673b3219a70c40105a7a0
  ...
  - path: docs/atlas/modules/plugins-forge-bin-chunk-1.md
    blob: 173510b93802798ce013d814021297ff73a42d67
  ...
  - path: docs/atlas/modules/plugins-forge-misc.md
    blob: fb06069829670d1f6b0741cb2d935bc1416094ce
  ...
  - path: docs/atlas/modules/plugins-freshen.md
    blob: a40b269052e07ee4260a692463e34af4d728a8df
  - path: docs/atlas/modules/plugins-greenlight.md
    blob: 3ed22acc52d0c0a0fbfd48a1bfd60ca312b021bd
  - path: docs/atlas/modules/plugins-handle-issue.md
    blob: 70438f7b96b5108bcd1329cbc312c06d92e05763
  - path: docs/atlas/modules/plugins-hook-guard.md
    blob: b175614a2486295953adf305cf333dd473410856
  - path: docs/atlas/modules/plugins-rca.md
    blob: 6c42c67748808065ec7daa754757f05e2c8313eb
  ...
  - path: docs/atlas/modules/plugins-semver-misc.md
    blob: 2b9bb8f05faf9b7b8f5615e24562408c78740a8c
  - path: docs/atlas/modules/plugins-semver-references.md
    blob: 4b2b4070f36c31d3319e895958f0ba44217b0cd1
...
scopes:
  - tree: .claude-plugin
    sha: 444b136719e3acdbe043621a89a1e6e2ca38ff03
  - tree: .semver
...
State is never held in conversation context across a pipeline's steps; each stateful plugin owns a gitignored artifact directory instead (`.forge/`, `.rca/<slug>/`, `.atlas/`, `.semver/`, `.freshen/`), and every resumption decision is derived from which files are present. The remaining cross-cutting seams are hook-mediated rather than call-mediated: semver's post-bump hook one-way-stamps `VERSION` into every other plugin's manifest; freshen's Stop/SessionStart hooks are the sole tmux mechanism any plugin uses to `/clear` and re-invoke between steps, driven by a signal file a plugin queues rather than a direct call; hook-guard's shared circuit breaker is sourced by any plugin's Stop hook to halt runaway loops; and greenlight's PreToolUse hook gates every Bash tool call regardless of which plugin is active. This hook layer is where plugins actually touch each other at runtime — everywhere else, a plugin's `bin/` is a closed deterministic world.

## Module relationships

- `plugins-atlas-bin-chunk-1 -> plugins-atlas-helpers-ts-helper (calls)`
- `plugins-atlas-bin-chunk-1 -> plugins-atlas-tests-chunk-1 (calls)`
- `plugins-atlas-bin-chunk-1 -> plugins-semver-misc (calls)`
- `plugins-atlas-helpers-ts-helper -> plugins-semver-misc (calls)`
- `plugins-atlas-tests-chunk-1 -> plugins-semver-misc (calls)`
- `plugins-atlas-tests-chunk-2 -> plugins-semver-misc (calls)`
- `plugins-deployit-assets -> plugins-atlas-bin-chunk-1 (calls)`
- `plugins-deployit-bin -> plugins-atlas-bin-chunk-1 (calls)`
- `plugins-deployit-bin -> plugins-semver-misc (calls)`
- `plugins-deployit-tests-chunk-2 -> plugins-atlas-bin-chunk-1 (calls)`
- `plugins-deployit-tests-chunk-2 -> plugins-deployit-bin (calls)`
- `plugins-deployit-tests-chunk-2 -> plugins-semver-misc (calls)`
- `plugins-forge-bin-chunk-1 -> plugins-semver-misc (calls)`
