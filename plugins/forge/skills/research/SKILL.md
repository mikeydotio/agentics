...
3. Read exactly one implementation completely:
   - Claude Code: `<plugin-root>/claude/skills/research/SKILL.md`
   - Codex: `<plugin-root>/codex/skills/research/SKILL.md`
4. If selection remains ambiguous, stop with `Ambiguous plugin host for forge:research`.
