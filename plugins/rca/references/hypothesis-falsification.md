...
Every hypothesis gets an experiment designed to REFUTE it, run by `agents:experimenter` in the
...
The surviving hypothesis goes to `agents:hypothesis-challenger` — including its experiment-
