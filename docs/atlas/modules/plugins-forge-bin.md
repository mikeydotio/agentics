...
- `plugins-forge-bin.forge-step-exit.sh -> plugins-freshen.freshen.sh (calls)`
- `plugins-forge-skills.forge/SKILL.md -> plugins-forge-bin.forge-state.sh (calls)`
- `plugins-forge-skills.forge/SKILL.md -> plugins-forge-bin.forge-status.sh (calls)`
- `plugins-forge-skills.forge/SKILL.md -> plugins-forge-bin.forge-step-exit.sh (calls)`
- `plugins-forge-skills.forge/SKILL.md -> plugins-forge-bin.forge-archive.sh (calls)`
- `plugins-forge-skills.forge/SKILL.md -> plugins-forge-bin.forge-fix-archive.sh (calls)`
- `plugins-forge-references.execution-loop.md -> plugins-forge-bin.forge-prechecks.sh (calls)`
