...
3. Read exactly one implementation completely:
   - Claude Code: `<plugin-root>/claude/skills/report/SKILL.md`
   - Codex: `<plugin-root>/codex/skills/report/SKILL.md`
4. If selection remains ambiguous, stop with `Ambiguous plugin host for rca:report`.
