...
3. Read exactly one implementation completely:
   - Claude Code: `<plugin-root>/claude/skills/triage/SKILL.md`
   - Codex: `<plugin-root>/codex/skills/triage/SKILL.md`
4. If selection remains ambiguous, stop with `Ambiguous plugin host for forge:triage`.
