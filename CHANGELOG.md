...
### Added
- support native Codex orchestration and lifecycle (AGE-94) (7658dd5)
- add Codex workflow with Claude compatibility (3608756)

### Fixed
- preserve clocks across processes (AGE-105) (4a3f453)
- use isolated shell suite entrypoint (AGE-104) (243e0c3)
- preserve gates around pending specialists (AGE-104) (cf29609)
- gate pipeline progress on bounded delivery (AGE-104) (376114f)
- preserve clock and recovery invariants (AGE-104) (131857a)
- share explorer configuration resolution (AGE-52) (5748d23)
- bound delivery and persist pending tasks (AGE-104) (8389404)
- layer live defaults under explicit pins (AGE-52) (b11d800)
- classify redirected explorer commands (AGE-54) (dfd8aeb)
- account for applied placeholder markers (AGE-39) (96a335f)
- retire blanket explorer approval (AGE-54) (2945d86)
- reconcile Forge host dispatch with current base (AGE-84) (e78bd9c)
- reject missing research option values (AGE-94) (a91e137)
- expire abandoned clear markers (AGE-100) (604db96)
- evaluate version guard dependencies through Make (AGE-102) (d89113c)
- integrate tested central gate receipts (AGE-81) (a343e84)
- evaluate version guard dependencies through Make (AGE-102) (017a76c)
- evaluate version guard dependencies through Make (AGE-102) (9ad71a1)
- evaluate version guard dependencies through Make (AGE-102) (661e5ab)
- certify the central test gate (AGE-102) (a713f56)
- certify the central test gate (AGE-102) (2150cd4)
- certify the central test gate (AGE-102) (048401f)
- certify the central test gate (AGE-102) (c77b3ce)
- preserve verifier-owned recovery work (AGE-84) (d63a409)
- preserve verifier-owned recovery work (AGE-84) (ce530b1)
- use StoryHook required workflow states (AGE-84) (c5040dc)
- include completed story history explicitly (AGE-84) (59d61f5)
- use StoryHook required workflow states (AGE-84) (14e3f4e)
- preserve verifier-owned recovery work (AGE-84) (9215720)
- include completed story history explicitly (AGE-84) (58dca9c)
- use StoryHook required workflow states (AGE-84) (62ee970)
- include completed story history explicitly (AGE-84) (92adfeb)
- preserve verifier-owned recovery work (AGE-84) (42063b4)
- use StoryHook required workflow states (AGE-84) (30ad348)
- include completed story history explicitly (AGE-84) (425f2c8)
- preserve verifier-owned recovery work (AGE-84) (3a0a1f0)
- use StoryHook required workflow states (AGE-84) (1a6936e)
- include completed story history explicitly (AGE-84) (ff91581)
- preserve verifier alternate object lookup (AGE-84) (b2ceb3d)
- preserve verifier alternate object lookup (AGE-84) (d127c10)
- preserve verifier alternate object lookup (AGE-84) (935eded)
- preserve verifier alternate object lookup (AGE-84) (433414c)
- preserve verifier alternate object lookup (AGE-84) (79259b6)
- parse release identity independently of locale (AGE-84) (ede62dc)
- parse release identity independently of locale (AGE-84) (ab825a1)
- parse release identity independently of locale (AGE-84) (bf80368)
- separate candidate and release content validation (AGE-84) (79a2bb2)
- parse release identity independently of locale (AGE-84) (83f5286)
- parse release identity independently of locale (AGE-84) (42cdb38)
- incorporate candidate content validation prerequisite (AGE-81) (5f2cc26)
- separate candidate and release content validation (AGE-84) (038630d)
- separate candidate and release content validation (AGE-84) (399ad7a)
- separate candidate and release content validation (AGE-84) (3be7626)
- ignore StoryHook dispatch witness (AGE-102) (2e617ef)
- ignore StoryHook dispatch witness (AGE-102) (bbce955)
- retain stop obligations across excluded phases (AGE-81) (7f34b1e)
- fail packaging checks when prerequisites are missing (AGE-81) (9abb4f1)
- bound silent seats and persist recovery state (AGE-81) (e9f6c80)
- keep dispatch sentinel out of submission changes (AGE-93) (a98843c)
- preserve dispatch witness without dirtying submission (AGE-103) (af73549)
- adapt approvals to the receiving host (AGE-103) (66fe644)
- ignore StoryHook dispatch witness (AGE-102) (0e297a1)
- resolve both host plugin roots (AGE-103) (2b5e20c)
- validate AI boolean responses (AGE-103) (11f2ae9)
- retire global pre-push test enforcement (AGE-102) (abd398f)
- resolve pre-push root from a command's own leading cd (3ac5c39)
- isolate claimed Codex signals (AGE-96) (b3d56ed)
- handshake Codex lifecycle resets (AGE-96) (38184a2)
- emit host-specific SessionStart JSON (AGE-95) (e63a250)
- resolve Codex hook plugin root (AGE-91) (7b7f277)

### Changed
- Merge pull request #199 from mikeydotio/worktree-AGE-105 (c002345)
- Merge pull request #197 from mikeydotio/worktree-AGE-104 (5f01d27)
- Merge pull request #198 from mikeydotio/worktree-AGE-52 (787255a)
- Merge pull request #196 from mikeydotio/worktree-AGE-54 (8d76175)
- Merge pull request #195 from mikeydotio/worktree-AGE-39 (f15b0d1)
- distinguish artifact names from JSON (AGE-104) (1aac6dc)
- Merge pull request #192 from mikeydotio/worktree-AGE-84 (7a5a2d5)
- Merge pull request #194 from mikeydotio/worktree-AGE-94 (f3129c8)
- Merge pull request #193 from mikeydotio/worktree-AGE-100 (c731d87)
- Merge pull request #189 from mikeydotio/worktree-AGE-103 (adcf835)
- Merge pull request #191 from mikeydotio/worktree-AGE-81 (863e938)
- Merge pull request #188 from mikeydotio/worktree-AGE-102 (0f1c25a)
- Merge pull request #190 from mikeydotio/worktree-AGE-93 (9b2e311)
- Merge pull request #186 from mikeydotio/codex-AGE-102 (616dd32)
- Merge pull request #185 from mikeydotio/worktree-AGE-101 (4dccfa1)
- Merge pull request #184 from mikeydotio/chore/untrack-handoff (f1c3540)
- Merge pull request #183 from mikeydotio/docs/readme-plugin-tables (7a14919)
- Merge pull request #181 from mikeydotio/rca-fix/freshen-codex-deferred-reset-false (3fec91a)
- Merge pull request #180 from mikeydotio/rca-fix/semver-codex-sessionstart-emits-invalid (8a9a64c)
- Merge pull request #179 from mikeydotio/fix/AGE-91-semver-codex-hooks (908acb0)
- Merge pull request #178 from mikeydotio/release/v3.9.1 (69fcd03)

### Documentation
- document every plugin and skill in the README (d02f265)
- record Freshen Codex lifecycle RCA (AGE-96) (bdf82e0)

### Testing
- synchronize explorer descendant readiness (AGE-104) (5712fa4)
- locate the real fence by content (AGE-104) (3bf5101)
- distinguish reset sends from StoryHook activity (AGE-94) (6805ca3)
- reap timed-out Git hook descendants (AGE-102) (0d06659)
- bound completed journal lookup (AGE-84) (1940b6d)
- bound completed journal lookup (AGE-84) (ddd8ae9)
- bound completed journal lookup (AGE-84) (7462d12)
- bound completed journal lookup (AGE-81) (6bf2bdc)
- bound completed journal lookup (AGE-84) (1305100)
- bound completed journal lookup (AGE-84) (c8085de)
- make fixture preconditions explicit (AGE-103) (c0d956a)

### Maintenance
- actually untrack HANDOFF.md (e404cce)
- untrack HANDOFF.md (4a443ea)
- retire the storywork plugin (5333b8e)
