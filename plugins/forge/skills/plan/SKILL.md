...
3. Read exactly one implementation completely:
   - Claude Code: `<plugin-root>/claude/skills/plan/SKILL.md`
   - Codex: `<plugin-root>/codex/skills/plan/SKILL.md`
4. If selection remains ambiguous, stop with `Ambiguous plugin host for forge:plan`.
