#!/usr/bin/env bash
# Test runner for the atlas plugin.
# Creates throwaway git repos in /tmp, exercises atlas-cli behaviors.
#
# Usage: bash tests/run-tests.sh [test-file-pattern]
#   e.g., bash tests/run-tests.sh scan       # runs only test-scan.sh
