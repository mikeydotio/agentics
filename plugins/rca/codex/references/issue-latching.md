...
Ambiguous bare numbers when both providers exist: one native question.

## Context detection (no explicit ref)

Fallback signals, in order; ANY hit requires one native question confirmation before latching
