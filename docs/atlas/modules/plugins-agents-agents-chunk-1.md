...
| `verdict` | JSON field | `plugins/agents/agents/evaluator.md:124` | pass/fail key forge's execute loop branches on; one failed criterion forces fail |
...
- Pipeline agents declare a methodology `Lineage` — `plugins/agents/agents/_template.md:89`
